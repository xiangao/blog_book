...
That last clause is easily overlooked, and it is the same clause that fixes the unbalanced two-way case
...
Latin squares, crop trials, where somebody chose the assignment.  Observational panels essentially never
have it, and a third factor makes matters worse rather than better, since it is often partly determined
by the first two.  In an audit panel I looked at recently, for instance, the third fixed effect was the
