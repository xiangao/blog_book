...
standalone energy-regression estimator. The code below shows the API;
see the [engression CRAN page](https://cran.r-project.org/package=engression)
for installation. The `Rfrengression` examples later in this chapter are
fully executable.
