...
Interaction estimator is the Lin ([2013](https://doi.org/10.1214/12-AOAS583), *Annals of Applied Statistics*) estimator, basically running a regression of $Y$ on $D$, $\tilde X$, and $D*\tilde X$.  $\tilde X$ is the demeaned $X$.  The coefficient of $D$ is the ATE.
