...
It is shown if  $R^2_{Y \sim Z|D,X} = 1$, then $R^2_{D \sim Z|X} \ge R^2_{Y \sim D|X}$ to make the effect go to 0.  Roughly speaking, the partial $R^2$ between the omitted variable and the treatment needs to exceed the partial $R^2$ between the treatment and the outcome to make the treatment effect go to 0.
