...
$$ \tau_{a_0,a_1,a_0',a_1'} = E[Y^{a_0,a_1} - Y^{a_0',a_1'}]$$
...
$$ Y^{\bar a}_t ⊥ A_t | H_t $$
where ${\bar a}_t = (a_1, ..., a_t)$, and $H_t$ is the history of treatment and covariates up to time t $$H_t=(A_0,  A_1, ..., A_{t-1}; L_1,..., L_{t})$$.
...
$$ L_1 | A_0 \sim Bernoulli\big(logit^{-1}(\gamma_0 + \gamma_1 A_0)\big)$$
