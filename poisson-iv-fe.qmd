...
This is the case people most often actually have, and it is the least settled.  Both procedures above
assume otherwise: Procedure 3's first stage is *linear*, and the companion probit procedure in the same
...
No built-in dataset has the shape that causes trouble, so this simulates one: a count outcome, a binary
endogenous regressor, an instrument, and two thousand units with between two and six observations each.
