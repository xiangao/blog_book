...
closely; only the plain Poisson shows a mild upward bias, because the unmodeled
excess zeros create overdispersion that it can absorb only through the
conditional mean. A misspecified zero process biases the count *slope* only when
