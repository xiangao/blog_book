...
ZIP with the correct zero-inflation model (using `z`) recovers the true
coefficient most accurately. Without `z`, all models show upward bias because
the zeros are incorrectly attributed to the count process.
