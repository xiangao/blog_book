...
The `numpyro` model corresponds to `FVC ~ Weeks + (1 + Weeks | Patient)`:
...
The `mcmc.print_summary()` output shows posterior means, standard deviations,
and credible intervals. Approximate output looks like this:
