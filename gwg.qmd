...
```
Sex ---> Employed FT/FY <--- U ---> Wage
```

Conditional on being in the sample, sex is no longer independent of potential wages. Sex is exogenous; *selected* sex is not. And note that no covariate adjustment addresses this --- it is a different problem with different remedies (Lee, 2009, sharp bounds; Neal, 2004; Olivetti and Petrongolo, 2008, imputation for non-workers).
...
### Two treatments, two adjustment sets
