...
Partial interference (Sobel, 2006; Hudgens & Halloran, 2008) is one way to make this manageable. Units are organized into clusters. Interference can happen within a cluster, but not between clusters. This is still a strong assumption, but it is weaker than no interference.

Qu et al. (2021) develop clustered IPW and AIPW estimators for this setting. The `CausalModel` R package implements them. Here I just simulate data and see how the functions work.
